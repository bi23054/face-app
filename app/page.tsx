    ...
    <div style={{display:"flex",height:"100vh",overflow:"hidden",background:"#edeae5",fontFamily:"'Georgia',serif"}}>
      ...
      <div style={{flex:"1",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:"32px 20px",background:"#f9f6f2",borderRight:"1px solid #ddd"}}>
        ...
        <div style={{display:"flex",gap:"10px",marginTop:"20px"}}>
          <button onClick={undo} disabled={!isMounted||!prev} style={{padding:"8px 22px",fontSize:"11px",borderRadius:"20px",border:"none",cursor:(isMounted&&prev)?"pointer":"default",background:(isMounted&&prev)?"#c8a97e":"#2a2520",color:(isMounted&&prev)?"#18150f":"#3a3530",letterSpacing:"1.5px",fontWeight:"bold"}}>↩ １個前に戻る</button>
